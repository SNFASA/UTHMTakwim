...
export const academicEvents: AcademicEvent[] = [
  { title: "Results exam", start: "2026-03-09", end: "-", type: "exam", color: "bg-blue-100 text-orange-700", date: "09 March" },
  { title: "Course Registration year 4 & 3", start: "2026-03-10", end: "2026-03-12", type: "admin", color: "bg-blue-100 text-blue-700", date: "10 - 12 March" },
  { title: "Course Registration year 2 & 1", start: "2026-03-11", end: "2026-03-12", type: "admin", color: "bg-blue-100 text-blue-700", date: "11 - 12 March" },
